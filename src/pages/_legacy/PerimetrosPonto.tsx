...
const PerimetrosPonto: React.FC = () => {
      ...
      <div className="perimetros-content">
        ...
        <div className="perimetros-info-column">
          <div className="perimetros-info-section">
            <h2>Pontos</h2>
            <p>
              Esta é a sua lista de pontos. Clique no nome desejado à esquerda para ver e alterar informações, ou clique no botão acima para adicionar uma novo.
            </p>
            <div className="perimetros-icon">
              <MapPin size={120} color="#ef4444" />
            </div>
          </div>
        </div>
      </div>
...
export default PerimetrosPonto;
